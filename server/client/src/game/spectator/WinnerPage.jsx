...
function WinnerPage({
  ...
  return (
    <main className="grid min-h-full place-items-center px-6 py-24 sm:py-32 lg:px-8 h-[calc(100%)] w-[calc(100%)] bg-[url('/src/assets/bluebkg.jpg')] dark:bg-[url('/src/assets/darkbluebkg.png')]">
      <div className="text-center py-20 px-10 bg-[length:100%_100%] bg-[url('/src/assets/scroll.png')] dark:bg-[url('/src/assets/darkscroll.png')]">
        <span
