function GamerulePage({ setGameStage }) {
  ...
  return (
    <main className="grid place-items-center bg-cover w-[calc(100%)] h-[calc(100%)] bg-[url('/src/assets/bluebkg.jpg')] dark:bg-[url('/src/assets/darkbluebkg.png')] pt-32 pb-24">
