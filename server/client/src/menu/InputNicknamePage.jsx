      ...
      <main className="grid h-screen w-screen place-items-center bg-[url(https://wallpapercave.com/wp/wp2874399.jpg)] px-6 py-24 sm:py-32 lg:px-8 bg-cover">
        <div className="text-center">
          <div className="text-center  bg-[url(https://thumbs.dreamstime.com/b/iron-background-threadbare-rusty-steel-covering-rivet-44688853.jpg)] bg-opacity-50 px-0 py-2 shadow-2xl sm:rounded-3xl border-2 border-slate-400">
            <h1 className="mt-0 text-12xl font-mono font-bold tracking-tight bg-gradient-to-r from-gray-400 via-gray-200 to-gray-400 inline-block px-2.5 py-1 text-transparent bg-clip-text sm:text-5xl">
              Input Nickname
            </h1>
          </div>
          <p className="text-3x1 font-semibold leading-7 sm:text-2xl">
            ...
            <button
              className="mx-2 rounded-md bg-gradient-to-r from-blue-600 to-sky-500 px-2.5 py-2.5 text-sm font-bold text-white shadow-sm sm:text-2xl hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
