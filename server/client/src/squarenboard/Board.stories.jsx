...
export const BlankBoard = () => {
  const board = [...Array(8)].map(e => Array(8).fill('blank'));
  return <Board board={board} size = 'big' />;
};
export const SelectedBoard = () => {
  const boardSelected = [...Array(8)].map(e => Array(8).fill('selected'));
  return <Board board={boardSelected} />;
};
export const TestBoard = () => {
  const testboard = [['blank', 'blank', 'hit', 'blank', 'blank', 'blank', 'blank','blank'],
