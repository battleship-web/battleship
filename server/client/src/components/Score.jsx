...
function Score({handleClickInstruction, user, setGameStage, board, onClick, size, opponentboard}) {
    return (
        <main className="text-center">
            <div className="text-center items-center mb-6 relative isolate overflow-hidden bg-[url(https://thumbs.dreamstime.com/b/iron-background-threadbare-rusty-steel-covering-rivet-44688853.jpg)] px-10 py-4 shadow-2xl sm:rounded-3xl">
                <h1 className="mt-2 text-3xl font-bold tracking-tight text-yellow-500 sm:text-5xl">BATTLESHIP </h1>
                <div className="mt-2 text-base leading-7 text-white font-bold bg-blue-600 rounded-md sm:text-2xl">Timer</div>
                ...
                <div className="mt-2 mb-12">
                    <div class="flex flex-row">
                            <h1 className="mr-2"><Board board={opponentboard} onClick={onClick} size={size}/></h1>
                            <h1 className="mt-20 text-orange-500 sm:text-8xl font-bold">vs</h1>
                            <h1 className="ml-2"><Board board={board} onClick={onClick} size={size}/></h1>
                    </div>
                </div>
            </div>
            <a
